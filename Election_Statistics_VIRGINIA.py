...
#sleep(4.53298)
driver.get("https://www.nbcnews.com/politics/2024-elections/virginia-president-results")
...
while True:
    ...
    for i,line in enumerate(lines):
        if('ACCOMACK' in line and not(counties_found)):
            ...
            try:
                ...
                if(first_iteration):
                    DataFrame([current_row],columns=['Total_Votes','KH_Vote_Count','KH_Vote_Pct','DT_Vote_Count','DT_Vote_Pct','Pct_Reported'],index=[extraction_time])\
                        .to_csv(f'State_Details/Virginia/{line.replace("-","_").replace(" ","_")}_Results.csv',
